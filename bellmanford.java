...
class Graph{
    ...
    Map<Integer, Integer> bellmanFord(int src){
    ...
    void displayRoutingTables(){
        for(int i=0; i<numNodes; i++){
            Map<Integer, Integer> routingTable = bellmanFord(i);
            if(routingTable!=null){
                ...
                System.out.println("No valid routing table for Node " + i + " due to negative-weight cycle");
            }
        }
    }
}
